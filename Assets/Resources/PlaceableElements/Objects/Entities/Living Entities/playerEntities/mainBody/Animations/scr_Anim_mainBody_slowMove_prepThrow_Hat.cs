...
public class scr_Anim_mainBody_slowMove_prepThrow_Hat : scr_Anim_mainBody_template
{
    ...
    public scr_Anim_mainBody_slowMove_prepThrow_Hat(string _objectName, string _objectType) : base(_objectName, _objectType) 
    {
        loadFrames("sp_mainBody_slowMove_prepThrow_Hat");
